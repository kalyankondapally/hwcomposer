...
bool DisplayPlaneManager::BeginUpdate(std::vector<OverlayLayer> &layers,
...
#ifdef USE_DRM_ATOMIC
bool DisplayPlaneManager::CommitFrameAtomic(
    DisplayPlaneStateList & /*planes*/, drmModeAtomicReqPtr /*property_set*/,
    bool /*needs_modeset*/, PageFlipState * /*state*/) {
  return false;
}

void DisplayPlaneManager::EndUpdate(drmModeAtomicReqPtr /*pset*/) {
}
#else
bool DisplayPlaneManager::CommitFrame(
    std::vector<OverlayLayer> & /*display_comp*/, PageFlipState * /*state*/) {
  // Handle Legacy case.
  return false;
}

void DisplayPlaneManager::EndUpdate() {
}
#endif
